...
ROSTER = [
    (41, "预言级", "Prophecy", "amarr", "battlecruiser", 4, "am_yuyan", "laser", 16233, 462, "large", True),
    (42, "先知级", "Absolution", "amarr", "battlecruiser", 4, "am_xianzhi", "laser", 22448, 456, "medium", False),
    (43, "先驱者级", "Harbinger", "amarr", "battlecruiser", 4, "am_xianquzhe", "laser", 24696, 456, "medium", False),
    (44, "末日沙场级", "Armageddon", "amarr", "battleship", 5, "am_morishachang", "laser", 643, 462, "large", False),
    (45, "灾难级", "Apocalypse", "amarr", "battleship", 5, "am_zainan", "laser", 642, 462, "large", False),
    (46, "地狱天使级", "Abaddon", "amarr", "battleship", 5, "am_diyutienshi", "laser", 24692, 462, "large", False),
    (47, "茶隼级", "Ferox", "caldari", "battlecruiser", 4, "jdl_chaxun", "rail", 16227, 570, "medium", False),
    (48, "猛鲑级", "Drake", "caldari", "battlecruiser", 4, "jdl_menggui", "missile", 24698, 501, "medium", False),
    (49, "幼龙级", "Nighthawk", "caldari", "battlecruiser", 4, "jdl_youliong", "missile", 22470, 501, "medium", False),
    (50, "毒蝎级", "Scorpion", "caldari", "battleship", 5, "jdl_duxie", "missile", 640, 501, "large", False),
    (51, "乌鸦级", "Raven", "caldari", "battleship", 5, "jdl_wuya", "missile", 638, 501, "large", False),
    (52, "鹏鲲级", "Rokh", "caldari", "battleship", 5, "jdl_pengkun", "rail", 24688, 574, "large", False),
    (53, "特里斯坦级", "Tristan", "gallente", "frigate", 2, "glt_telisitan", "rail", 593, 561, "small", False),
    (54, "布鲁提克斯级", "Brutix", "gallente", "battlecruiser", 4, "glt_bulutikesi", "rail", 16229, 570, "medium", False),
    (55, "弥尔米顿级", "Myrmidon", "gallente", "battlecruiser", 4, "glt_miermidun", "rail", 24700, 570, "medium", False),
    (56, "多米尼克斯级", "Dominix", "gallente", "battleship", 5, "glt_duominikesi", "rail", 645, 574, "large", False),
    (57, "万王宝座级", "Megathron", "gallente", "battleship", 5, "glt_wanwangbaozuo", "rail", 641, 574, "large", False),
    (58, "亥伯龙神级", "Hyperion", "gallente", "battleship", 5, "glt_haibolongshen", "rail", 24690, 574, "large", False),
    (59, "暴风级", "Tempest", "minmatar", "battleship", 5, "mmte_baofeng", "cannon", 639, 498, "large", False),
    (60, "飓风级", "Hurricane", "minmatar", "battlecruiser", 4, "mmte_jufeng", "cannon", 24702, 491, "medium", False),
    (61, "台风级", "Typhoon", "minmatar", "battleship", 5, "mmte_taifeng", "missile", 644, 501, "large", False),
    (62, "狂暴级", "Maelstrom", "minmatar", "battleship", 5, "mmte_kuangbao", "cannon", 24694, 498, "large", False),
    (63, "死亡漩涡级", "Hel", "minmatar", "battleship", 5, "mmte_siwangxuanwo", "missile", 22852, 501, "large", False),
    # 大炮战巡（大型武器）
    (64, "塔洛斯级", "Talos", "gallente", "battlecruiser", 4, "glt_taluosi", "rail", 4308, 573, "large", True),
    (65, "纳迦级", "Naga", "caldari", "battlecruiser", 4, "jdl_najia", "rail", 4306, 574, "large", True),
    (66, "龙卷风级", "Tornado", "minmatar", "battlecruiser", 4, "mmte_longjuanfeng", "cannon", 4310, 498, "large", True),
]
