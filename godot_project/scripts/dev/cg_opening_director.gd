...
const RACES := [
	{"id": 201, "race": "A", "race_id": "amarr", "model_key": "tq_titan_a", "sc_key": "tq_supercarrier_a", "sc_id": 971, "sc_name": "永恒级", "sc_alias": "万古", "sc_name_en": "Aeon", "name": "圣像级", "name_en": "Avatar", "color": Color(1.0, 0.82, 0.28), "sky_jpeg": "res://assets/skyboxes/amarr.jpeg"},
	{"id": 202, "race": "C", "race_id": "caldari", "model_key": "tq_titan_c", "sc_key": "tq_supercarrier_c", "sc_id": 972, "sc_name": "飞龙级", "sc_alias": "飞龙", "sc_name_en": "Wyvern", "name": "利维坦级", "name_en": "Leviathan", "color": Color(0.35, 0.72, 1.0), "sky_jpeg": "res://assets/skyboxes/wormhole.jpeg"},
	{"id": 203, "race": "G", "race_id": "gallente", "model_key": "tq_titan_g", "sc_key": "tq_supercarrier_g", "sc_id": 973, "sc_name": "尼克斯级", "sc_alias": "夜神", "sc_name_en": "Nyx", "name": "厄勒布洛斯级", "name_en": "Erebus", "color": Color(0.35, 1.0, 0.55), "sky_jpeg": "res://assets/skyboxes/gallente.jpeg"},
	{"id": 204, "race": "M", "race_id": "minmatar", "model_key": "tq_titan_m", "sc_key": "tq_supercarrier_m", "sc_id": 974, "sc_name": "地狱级", "sc_alias": "冥府", "sc_name_en": "Hel", "name": "诸神黄昏级", "name_en": "Ragnarok", "color": Color(1.0, 0.42, 0.12), "sky_jpeg": "res://assets/skyboxes/amarr.jpeg"},
]
...
func _set_sky_race(def: Dictionary) -> void:
	var path := str(def.get("sky_jpeg", "res://assets/skyboxes/amarr.jpeg"))
	_apply_panorama(path)


func _set_sky_neutral() -> void:
	_apply_panorama("res://assets/skyboxes/gallente.jpeg")
